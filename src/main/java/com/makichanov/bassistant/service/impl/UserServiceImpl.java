package com.makichanov.bassistant.service.impl;

import com.makichanov.bassistant.dao.EntityTransaction;
import com.makichanov.bassistant.dao.UserDao;
import com.makichanov.bassistant.dao.impl.UserDaoImpl;
...
public class UserServiceImpl implements UserService {
    ...
    public boolean authenticateByEmail(String email, String password) throws ServiceException {
        try(EntityTransaction transaction = new EntityTransaction()) {
            UserDao userDao = new UserDaoImpl();
            transaction.initTransaction(userDao);
            Optional<User> queryResult = findByEmail(email);
