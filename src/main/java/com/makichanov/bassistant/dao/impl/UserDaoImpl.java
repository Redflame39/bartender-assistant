package com.makichanov.bassistant.dao.impl;

import com.makichanov.bassistant.dao.UserDao;
...
public class UserDaoImpl extends UserDao {
    ...
    private static final String SQL_FIND_BY_EMAIL = "select user_id, username role.role_name from users where email = ?;";
    ...
    public User findByEmail(String email) throws DaoException {
        try (PreparedStatement statement = connection.prepareStatement(SQL_FIND_BY_EMAIL)) {
            ...
            if (resultSet.next()) {
                ...
                return new User(username, userId, Role.valueOf(role), email);
            } else {
                return null;
            }
        } catch (SQLException e) {
